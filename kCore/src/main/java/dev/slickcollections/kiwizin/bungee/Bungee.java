...
public class Bungee extends Plugin {
  ...
  public static void applyFake(ProxiedPlayer player, String fakeName, String role, String skin) {
    player.disconnect(TextComponent.fromLegacyText(StringUtils.formatColors(KCoreSettings.Fake.KICK_APPLY).replace("\\n", "\n")));
  ...
  public static void removeFake(ProxiedPlayer player) {
    player.disconnect(TextComponent.fromLegacyText(StringUtils.formatColors(KCoreSettings.Fake.KICK_REMOVE).replace("\\n", "\n")));
  ...
  public static List<String> getRandomNicks() {
    return KCoreSettings.Fake.RANDOM_NICKS;
  }
  ...
  public void onEnable() {
    ...
    dev.slickcollections.kiwizin.player.role.RolePermissionManager.setup();
