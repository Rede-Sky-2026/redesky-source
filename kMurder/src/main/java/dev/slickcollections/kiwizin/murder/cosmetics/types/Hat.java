...
public class Hat extends Cosmetic {
    ...
    public ItemStack getIcon(Profile profile) {
        ...
        String desc = (has && canBuy ?
                KCoreSettings.Murder.cosmetics$hat$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.Murder.cosmetics$icon$has_desc$selected : KCoreSettings.Murder.cosmetics$icon$has_desc$select) :
                canBuy ?
                        KCoreSettings.Murder.cosmetics$hat$icon$buy_desc$start.replace("{buy_desc_status}",
                        ...
                        KCoreSettings.Murder.cosmetics$hat$icon$perm_desc$start
