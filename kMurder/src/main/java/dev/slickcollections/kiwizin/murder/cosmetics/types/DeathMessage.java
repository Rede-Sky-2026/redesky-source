...
public class DeathMessage extends Cosmetic {
    ...
    public ItemStack getIcon(Profile profile) {
        ...
        String desc = (has && canBuy ?
                KCoreSettings.Murder.cosmetics$deathmessage$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.Murder.cosmetics$icon$has_desc$selected : KCoreSettings.Murder.cosmetics$icon$has_desc$select) :
                canBuy ?
                        KCoreSettings.Murder.cosmetics$deathmessage$icon$buy_desc$start
                        ...
                        KCoreSettings.Murder.cosmetics$deathmessage$icon$perm_desc$start
