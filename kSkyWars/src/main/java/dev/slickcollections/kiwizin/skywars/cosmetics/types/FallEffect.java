...
public class FallEffect extends Cosmetic implements Listener {
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String desc = (has && canBuy ?
        KCoreSettings.SkyWars.cosmetics$fall_effect$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.SkyWars.cosmetics$icon$has_desc$selected : KCoreSettings.SkyWars.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.SkyWars.cosmetics$fall_effect$icon$buy_desc$start
            ...
            KCoreSettings.SkyWars.cosmetics$fall_effect$icon$perm_desc$start
