...
public class TeleportEffect extends Cosmetic implements Listener {
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String desc = (has && canBuy ?
        KCoreSettings.SkyWars.cosmetics$teleport_effect$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.SkyWars.cosmetics$icon$has_desc$selected : KCoreSettings.SkyWars.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.SkyWars.cosmetics$teleport_effect$icon$buy_desc$start
            ...
            KCoreSettings.SkyWars.cosmetics$teleport_effect$icon$perm_desc$start
