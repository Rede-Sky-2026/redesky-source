...
public class Balloon extends Cosmetic {
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String desc = (has && canBuy ?
        KCoreSettings.SkyWars.cosmetics$balloon$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.SkyWars.cosmetics$icon$has_desc$selected : KCoreSettings.SkyWars.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.SkyWars.cosmetics$balloon$icon$buy_desc$start
            ...
            KCoreSettings.SkyWars.cosmetics$balloon$icon$perm_desc$start
