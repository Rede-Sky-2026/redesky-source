...
import dev.slickcollections.kiwizin.skywars.cosmetics.types.winanimations.*;
...
public abstract class WinAnimation extends Cosmetic {
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String color = has ? (isSelected ? KCoreSettings.SkyWars.cosmetics$color$selected : KCoreSettings.SkyWars.cosmetics$color$unlocked)
    ...
    String desc = (has && canBuy ?
        KCoreSettings.SkyWars.cosmetics$win_animation$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.SkyWars.cosmetics$icon$has_desc$selected : KCoreSettings.SkyWars.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.SkyWars.cosmetics$win_animation$icon$buy_desc$start
            ...
            KCoreSettings.SkyWars.cosmetics$win_animation$icon$perm_desc$start
