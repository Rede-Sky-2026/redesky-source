...
public class DeathMessage extends Cosmetic {
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String desc = (has && canBuy ?
        KCoreSettings.SkyWars.cosmetics$deathmessage$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.SkyWars.cosmetics$icon$has_desc$selected : KCoreSettings.SkyWars.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.SkyWars.cosmetics$deathmessage$icon$buy_desc$start
            ...
            KCoreSettings.SkyWars.cosmetics$deathmessage$icon$perm_desc$start
