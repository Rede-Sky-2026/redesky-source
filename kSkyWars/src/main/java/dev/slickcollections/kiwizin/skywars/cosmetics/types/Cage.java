...
public class Cage extends Cosmetic {
  ...
  public static void createCage(Player player, String name) {
    ...
    new Cage(id, EnumRarity.COMUM, 10000.0, 50, "", name, "GLASS : 1", blocks, false);
  }
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String desc = (has && canBuy ?
        KCoreSettings.SkyWars.cosmetics$cage$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.SkyWars.cosmetics$icon$has_desc$selected : KCoreSettings.SkyWars.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.SkyWars.cosmetics$cage$icon$buy_desc$start.replace("{buy_desc_status}",
                (coins >= this.getCoins() || (CashManager.CASH && cash >= this.getCash())) ? KCoreSettings.SkyWars.cosmetics$icon$buy_desc$click_to_buy : KCoreSettings.SkyWars.cosmetics$icon$buy_desc$enough) :
            KCoreSettings.SkyWars.cosmetics$cage$icon$perm_desc$start
