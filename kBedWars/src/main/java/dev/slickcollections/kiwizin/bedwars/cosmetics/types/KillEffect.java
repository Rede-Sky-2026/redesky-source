...
import dev.slickcollections.kiwizin.bedwars.cosmetics.types.killeffects.*;
...
public abstract class KillEffect extends Cosmetic {
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String desc = (has && canBuy ?
        KCoreSettings.BedWars.cosmetics$kill_effect$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.BedWars.cosmetics$icon$has_desc$selected : KCoreSettings.BedWars.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.BedWars.cosmetics$kill_effect$icon$buy_desc$start
            ...
            KCoreSettings.BedWars.cosmetics$kill_effect$icon$perm_desc$start
