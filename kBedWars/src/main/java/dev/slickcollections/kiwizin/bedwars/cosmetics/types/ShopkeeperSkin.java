...
public class ShopkeeperSkin extends Cosmetic {
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String desc = (has && canBuy ?
        KCoreSettings.BedWars.cosmetics$shopkeeperskin$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.BedWars.cosmetics$icon$has_desc$selected : KCoreSettings.BedWars.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.BedWars.cosmetics$shopkeeperskin$icon$buy_desc$start
            ...
            KCoreSettings.BedWars.cosmetics$shopkeeperskin$icon$perm_desc$start
