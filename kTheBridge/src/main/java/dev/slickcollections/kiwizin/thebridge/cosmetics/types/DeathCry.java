...
public class DeathCry extends Cosmetic {
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String desc = (has && canBuy ?
        KCoreSettings.TheBridge.cosmetics$deathcry$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.TheBridge.cosmetics$icon$has_desc$selected : KCoreSettings.TheBridge.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.TheBridge.cosmetics$deathcry$icon$buy_desc$start
            ...
            KCoreSettings.TheBridge.cosmetics$deathcry$icon$perm_desc$start
