...
public class MenuBuyCashCosmetic<T extends Cosmetic> extends PlayerMenu {
  ...
  public MenuBuyCashCosmetic(Profile profile, String name, T cosmetic, Class<? extends Cosmetic> cosmeticClass) {
    ...
    this.setItem(15, BukkitUtils.deserializeItemStack("STAINED_GLASS_PANE:14 : 1 : nome>&cCancelar : desc>&7Voltar para " + this.name + "."));
      ...
      if (evt.getWhoClicked().equals(this.player)) {
        ...
        if (evt.getClickedInventory() != null && evt.getClickedInventory().equals(this.getInventory())) {
          ...
          if (item != null && item.getType() != Material.AIR) {
            if (evt.getSlot() == 11) {
              if (profile.getCoins("kCoreTheBridge") < this.cosmetic.getCoins()) {
              ...
              profile.removeCoins("kCoreTheBridge", this.cosmetic.getCoins());
