...
public class Balloon extends Cosmetic {
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String desc = (has && canBuy ?
        KCoreSettings.TheBridge.cosmetics$balloon$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.TheBridge.cosmetics$icon$has_desc$selected : KCoreSettings.TheBridge.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.TheBridge.cosmetics$balloon$icon$buy_desc$start
            ...
            KCoreSettings.TheBridge.cosmetics$balloon$icon$perm_desc$start
