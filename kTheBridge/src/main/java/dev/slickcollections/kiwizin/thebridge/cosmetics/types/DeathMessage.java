...
public class DeathMessage extends Cosmetic {
  ...
  public static final KLogger LOGGER = ((KLogger) dev.slickcollections.kiwizin.thebridge.Main.getInstance().getLogger()).getModule("DEATH_CRY");
  ...
  public static void setupDeathMessages() {
    KConfig config = dev.slickcollections.kiwizin.thebridge.Main.getInstance().getConfig("cosmetics", "deathmessages");
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String desc = (has && canBuy ?
        KCoreSettings.TheBridge.cosmetics$deathmessage$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.TheBridge.cosmetics$icon$has_desc$selected : KCoreSettings.TheBridge.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.TheBridge.cosmetics$deathmessage$icon$buy_desc$start
            ...
            KCoreSettings.TheBridge.cosmetics$deathmessage$icon$perm_desc$start
