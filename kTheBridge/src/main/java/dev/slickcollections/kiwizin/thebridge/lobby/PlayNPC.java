...
public class PlayNPC {
  ...
  public PlayNPC(Location location, String id, TheBridgeMode mode) {
  ...
  public static void setupNPCs() {
    ...
    for (String serialized : CONFIG.getStringList("play")) {
      if (serialized.split("; ").length > 6) {
        ...
        TheBridgeMode mode = TheBridgeMode.fromName(serialized.split("; ")[7]);
        if (mode == null) {
          continue;
        }
  ...
  public static void add(String id, Location location, TheBridgeMode mode) {
