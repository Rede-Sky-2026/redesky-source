...
public class StatsNPC {
  ...
  public void spawn() {
    ...
    for (int index = KCoreSettings.TheBridge.lobby$npc$stats$hologram.size(); index > 0; index--) {
      this.hologram.withLine(KCoreSettings.TheBridge.lobby$npc$stats$hologram.get(index - 1));
    }
