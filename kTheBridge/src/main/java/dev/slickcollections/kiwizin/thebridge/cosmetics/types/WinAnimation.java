...
import dev.slickcollections.kiwizin.thebridge.cosmetics.types.winanimations.*;
...
public abstract class WinAnimation extends Cosmetic {
  ...
  public ItemStack getIcon(Profile profile) {
    ...
    String color = has ? (isSelected ? KCoreSettings.TheBridge.cosmetics$color$selected : KCoreSettings.TheBridge.cosmetics$color$unlocked)
    ...
    String desc = (has && canBuy ?
        KCoreSettings.TheBridge.cosmetics$win_animation$icon$has_desc$start.replace("{has_desc_status}", isSelected ? KCoreSettings.TheBridge.cosmetics$icon$has_desc$selected : KCoreSettings.TheBridge.cosmetics$icon$has_desc$select) :
        canBuy ?
            KCoreSettings.TheBridge.cosmetics$win_animation$icon$buy_desc$start
            ...
            KCoreSettings.TheBridge.cosmetics$win_animation$icon$perm_desc$start
