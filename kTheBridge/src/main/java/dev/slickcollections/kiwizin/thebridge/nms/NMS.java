package dev.slickcollections.kiwizin.thebridge.nms;
...
import dev.slickcollections.kiwizin.thebridge.nms.entity.*;
import dev.slickcollections.kiwizin.thebridge.nms.interfaces.BalloonEntity;
...
public class NMS {
  ...
  public static Entity createAttachedCart(String owner, Location location) {
    ...
    NMS.look(cart.getBukkitEntity(), location.getYaw(), location.getPitch());
